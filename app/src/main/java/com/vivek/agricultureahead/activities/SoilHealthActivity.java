...
import com.vivek.agricultureahead.adapters.SoilHealthCardAdapter;
import com.vivek.agricultureahead.models.ItemHealthCard;
import com.vivek.agricultureahead.utilities.SqliteHelper;
...
public class SoilHealthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list2.add("Select District (जिला)");
