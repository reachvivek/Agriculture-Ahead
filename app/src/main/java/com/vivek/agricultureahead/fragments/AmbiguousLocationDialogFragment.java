package com.vivek.agricultureahead.fragments;
...
import com.vivek.agricultureahead.activities.WeatherActivity;
import com.vivek.agricultureahead.adapters.LocationsRecyclerAdapter;
...
public class AmbiguousLocationDialogFragment extends DialogFragment implements LocationsRecyclerAdapter.ItemClickListener {
    ...
    public void onItemClickListener(View view, int position) {
        ...
        final Intent intent = new Intent(getActivity(), WeatherActivity.class);
